...
import com.example.wanandroid.databinding.FragmentProjectPageBinding
...
class ProjectPageFragment : StatusFragment() {
    ...
    override fun onCreateView(
        ...
        binding = FragmentProjectPageBinding.inflate(inflater, container, false)
        return binding.root
    }
